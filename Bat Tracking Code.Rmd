...
## I took data from Baseball Savant from 24 and 25 and downloaded them into CSVs. 
## The hitters in my set are all qualified
## hitters from that individual year
...
ggplot(bat_power_plot, aes(x = attack_angle_diff, y = xSLG_diff)) +
  ...
  # headshots only for leaders and laggards
  ggimage::geom_image(
    data = bat_power_plot %>% 
